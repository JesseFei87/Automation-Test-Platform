...
/*
 * PixelBlast — interactive WebGL pixel-noise background.
 * Source: DavidHDev/react-bits (src/ts-default/Backgrounds/PixelBlast/PixelBlast.tsx)
 * Vendored locally so the project stays on its self-built CSS approach (no Tailwind / no shadcn registry).
 * Dependencies: three, postprocessing (added to web-ui/package.json on 2026-07-09).
 */
...
float vnoise(vec3 p){
  ...
  float n011 = hash11(dot(ip + vec3(0.0,1.0,0.0), vec3(1.0,57.0,113.0)));
