...
- User: `Tester`
- Admin password: configured locally in System Settings, not committed.
- Device VNC password: configured locally in System Settings or YAML input values, not committed.
