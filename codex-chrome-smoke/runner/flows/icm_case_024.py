...
async def run(page, system, case) -> None:
    ...
    if await page.locator('tbody tr').filter(has_text='ABCD').count():
        await ensure_text_visible(page, 'ABCD')
        return
    ...
    await inputs.nth(2).fill('ABCD')
    await inputs.nth(3).fill('192.168.1.100')
    await inputs.nth(4).fill('22')
    ...
    if await remark_field.count():
        await remark_field.fill('')
